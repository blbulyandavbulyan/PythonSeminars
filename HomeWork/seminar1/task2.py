...
24 -> 4  16  4
    60 -> 10  40  10
'''
s = int(input('Введите S(сколько всего сделали Петя, Катя и Серёжа: '))
petya = int(s/6) # отбрасываем дробную часть, т.к. странно если они сделали 1 не целый журавлик
sergey = petya
katya = 4*petya
